import { FileText, Filter, Clock, DollarSign, Shield } from 'lucide-react'
...
const overviewConfig = [
  ...
  { key: 'drivingHourPolicies', label: 'Driving Hour Policies', icon: Clock },
  { key: 'destinationFilterPolicies', label: 'Destination Filter Policies', icon: Filter },
