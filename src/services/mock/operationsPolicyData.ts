...
export let mockOperationsPolicies: OperationsPolicyRule[] = [
  { id: 'op-df-3', category: 'destination_filter', name: 'Filter Expiration Default', description: 'Global default expiration time for active filters (tier-specific limits are in Tier Management)', value: '6 hours', numericValue: 6, unit: 'hours', status: 'active', lastUpdated: '2026-04-20T00:00:00Z', updatedBy: 'Operations Manager' },
